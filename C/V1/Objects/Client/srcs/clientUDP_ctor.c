...
static t_bool			clientUDP_configSockaddr(SOCKADDR_IN *sockaddr,
...
t_bool				clientUDP_ctor(t_client *this,
					       ...
					       uint16_t const port)
{
  if (client_ctor(this, SOCKET_UDP, sizeof(SOCKADDR_IN)))
    return (clientUDP_configSockaddr((SOCKADDR_IN *)this->_socket._sockaddr,
				     addressHost, port));
  return (false);
}
